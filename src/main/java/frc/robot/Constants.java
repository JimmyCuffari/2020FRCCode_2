...
public final class Constants {
    ...
    public static class DriveConstants {
       ...
       public static int kleftTwo = 2;
       public static int krightOne = 3;
       public static int krightTwo = 4;
    }

    public static class FlywheelConstants {
        public static int kflywheelOne = 7;
        public static int kflywheelTwo = 8;
    }

    public static class ColorWheelConstants {
        public static int kcolorWheel = 6;
    ...
    public static class TurretConstants {
        public static int kturretOne = 10;
        public static int kturretTwo = 11;
    }
